...
namespace Timetube {
    ...
    public sealed class FolderBrowser : Component {
        ...
        // Browse info options.
        private int publicOptions = (int)Win32.Shell32.BffStyles.RestrictToFilesystem |
             (int)Win32.Shell32.BffStyles.RestrictToDomain;
        private int privateOptions = (int)Win32.Shell32.BffStyles.NewDialogStyle;
        ...
        private static Win32.IMalloc GetSHMalloc() {
            ...
            Win32.Shell32.SHGetMalloc(out malloc);
            return malloc;
        }
        ...
        public DialogResult ShowDialog(IWin32Window owner) {
            ...
            if (owner != null) {
                ...
                hWndOwner = Win32.GetActiveWindow();
            }

            // Get the IDL for the specific startLocation.
            Win32.Shell32.SHGetSpecialFolderLocation(hWndOwner, (int)startLocation, out pidlRoot);
            ...
            if ((mergedOptions & (int)Win32.Shell32.BffStyles.NewDialogStyle) != 0) {
                if (System.Threading.ApartmentState.MTA == Application.OleRequired())
                    mergedOptions = mergedOptions & (~(int)Win32.Shell32.BffStyles.NewDialogStyle);
            }
            ...
            try {
                ...
                Win32.Shell32.BROWSEINFO bi = new Win32.Shell32.BROWSEINFO();
                ...
                // Show the dialog.
                pidlRet = Win32.Shell32.SHBrowseForFolder(ref bi);
                ...
                if (0 == Win32.Shell32.SHGetPathFromIDList(pidlRet, sb)) {
                    return DialogResult.Cancel;
                }
        ...
        public bool OnlyFilesystem {
            get {
                return (publicOptions & (int)Win32.Shell32.BffStyles.RestrictToFilesystem) != 0;
            }
            set {
                SetOptionField((int)Win32.Shell32.BffStyles.RestrictToFilesystem, value);
            }
        }
